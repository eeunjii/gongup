...
-->
  ...
  <link rel="stylesheet" href="./css/qcommon.css" />
</head>
<body>
  <div>
    <div class="asdf">
      ...
      <div style="margin-top: -100px; margin-left: 100px; width: 1000px">
        ...
        <div style= "margin-top:100px">
          ...
          <div class="undermenu2_wrap">
            <p class="notice_caption">
              회원들과
              <br><strong>질의응답</strong>을 할 수 있는 공간입니다.
            </p>
              <table class="undermenu2">
                <caption>질의응답</caption>

                <thread>
                  <tr>
                    <th class="under_no">NO</th>
                    <th class="under_title">TITEL</th>
                    <th class="under_date">DATE</th>
                  </tr>
                </thread>
                <tbody>
                  <tr>
